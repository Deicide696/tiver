    ...
    public function addDaviPlataCharge($body)
    {
        ...
        try
        {
            list($response, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams, '\app\assets\Tpaga\Model\DaviPlataCharge'
            );
            ...
            return $this->apiClient->getSerializer()->deserialize($response, '\app\assets\Tpaga\Model\DaviPlataCharge', $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 201:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\app\assets\Tpaga\Model\DaviPlataCharge', $e->getResponseHeaders());
    ...
    public function addDaviPlataChargeback($body)
    {
        ...
        try
        {
            list($response, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, $method,
                $queryParams, $httpBody,
                $headerParams, '\app\assets\Tpaga\Model\DaviPlataChargeback'
            );
            ...
            return $this->apiClient->getSerializer()->deserialize($response, '\app\assets\Tpaga\Model\DaviPlataChargeback', $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 201:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\app\assets\Tpaga\Model\DaviPlataChargeback', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            case 402:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\app\assets\Tpaga\Model\DaviPlataChargeback', $e->getResponseHeaders());
    ...
    public function addDaviPlata($customer_id, $body)
    {
        ...
        try
        {
            list($response, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, $method,
                $queryParams, $httpBody,
                $headerParams, '\app\assets\Tpaga\Model\DaviPlata'
            );
            ...
            return $this->apiClient->getSerializer()->deserialize($response, '\app\assets\Tpaga\Model\DaviPlata', $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 201:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\app\assets\Tpaga\Model\DaviPlata', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            case 422:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\app\assets\Tpaga\Model\ApiError', $e->getResponseHeaders());
