    ...
    public function createCustomer($body)
    {
        ...
        try
        {
            list($response, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams, '\app\assets\Tpaga\Model\Customer'
            );
            ...
            return $this->apiClient->getSerializer()->deserialize($response, '\app\assets\Tpaga\Model\Customer', $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 201:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\app\assets\Tpaga\Model\Customer', $e->getResponseHeaders());
