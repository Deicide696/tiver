 ...
 *
 */
namespace app\assets\Facebook\GraphNodes;

use app\assets\Facebook\FacebookResponse;
...
class GraphNodeFactory
{
     ...
     */
    const BASE_GRAPH_NODE_CLASS = 'app\assets\Facebook\GraphNodes\GraphNode';

    /**
     * @const string The base graph edge class.
     */
    const BASE_GRAPH_EDGE_CLASS = 'app\assets\Facebook\GraphNodes\GraphEdge';

    /**
     * @const string The graph object prefix.
     */
    const BASE_GRAPH_OBJECT_PREFIX = 'app\assets\\Facebook\GraphNodes\\';
