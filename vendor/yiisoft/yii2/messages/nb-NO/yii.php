...
return [
    ...
    '¿Desea realmente eliminar este elemento?' => 'Er du sikker på at du vil slette dette elementet?',
    'Delete' => 'Slett',
    'Error' => 'Feil',
    ...
    'The file "{file}" is too big. Its size cannot exceed {limit, number} {limit, plural, one{byte} other{bytes}}.' => 'Filen "{file}" er for stor. Størrelsen kan ikke overskride {limit, number} {limit, plural, one{byte} other{bytes}}.',
    'The file "{file}" is too small. Its size cannot be smaller than {limit, number} {limit, plural, one{byte} other{bytes}}.' => 'Filen "{file}" er for liten. Størrelsen kan ikke være mindre enn {limit, number} {limit, plural, one{byte} other{bytes}}.',
