...
return [
    ...
    '¿Desea realmente eliminar este elemento?' => 'Jeste li sigurni da želite obrisati ovu stavku?',
    'Delete' => 'Obriši',
    'Error' => 'Greška',
    ...
    'The file "{file}" is too big. Its size cannot exceed {limit, number} {limit, plural, one{byte} other{bytes}}.' => 'Datoteka "{file}" je prevelika. Veličina ne smije biti veća od {limit, number} {limit, plural, one{bajta} few{bajtova} other{bajtova}}.',
    'The file "{file}" is too small. Its size cannot be smaller than {limit, number} {limit, plural, one{byte} other{bytes}}.' => 'Datoteka "{file}" је premala. Veličina ne smije biti manja od {limit, number} {limit, plural, one{bajta} few{bajtova} other{bajtova}}.',
