...
return [
    ...
    '¿Desea realmente eliminar este elemento?' => 'Sizni ushbu elementni o`chirishga ishonchngiz komilmi?',
    'Delete' => 'O`chirish',
    'Error' => 'Xato',
    ...
    'The file "{file}" is too big. Its size cannot exceed {limit, number} {limit, plural, one{byte} other{bytes}}.' => '«{file}» fayl juda katta. O`lcham {limit, number} {limit, plural, one{baytdan} few{baytdan} many{baytdan} other{baytdan}} oshishi kerak emas.',
    'The file "{file}" is too small. Its size cannot be smaller than {limit, number} {limit, plural, one{byte} other{bytes}}.' => '«{file}» fayl juda kichkina. O`lcham {limit, number} {limit, plural, one{baytdan} few{baytdan} many{baytdan} other{baytdan}} kam bo`lmasligi kerak.',
